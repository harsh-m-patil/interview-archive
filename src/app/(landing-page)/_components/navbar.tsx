    ...
    dropdownItems: [
      {
        name: "Questions",
        href: "/questions",
        description: "Share and discuss interview questions",
      },
      {
        name: "Dashboard",
        href: "/dashboard",
        ...
        <div className="flex h-16 items-center justify-between lg:h-20">
          ...
          >
            <Link href="/" className="flex items-center space-x-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-primary/50 to-primary/70">
                <BadgeQuestionMark className="h-5 w-5 text-white" />
              </div>
              <span className="bg-gradient-to-r from-primary/60 to-primary/90 bg-clip-text text-xl font-bold text-transparent">
                Interview Archive
              </span>
            </Link>
          </motion.div>
              ...
              <div className="border-border bg-background/95 mt-4 space-y-2 rounded-xl border py-4 shadow-xl backdrop-blur-lg">
                ...
                <div className="space-y-2 px-4 py-2">
                  ...
                  >
                    <Button
                      variant="secondary"
                      className="w-full rounded-full py-2 px-4 text-center"
                    >
                      Get Started
                    </Button>
                  </Link>
